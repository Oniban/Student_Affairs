import { Eye, Target, Sparkles, HeartHandshake, Compass, Users } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="border-b border-slate-200 pb-8 dark:border-slate-800">
          ...
          <p className="mt-3 text-base text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
            The core principles, philosophy, and strategic objectives that govern all operations of the Student Affairs Office.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="relative group overflow-hidden rounded-2xl border border-indigo-100 bg-indigo-50/20 dark:border-indigo-950/40 dark:bg-slate-900/20 p-8 hover:shadow-lg transition-all duration-300">
            ...
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-indigo-100 text-indigo-600 dark:bg-indigo-950 dark:text-indigo-400 mb-6">
          ...
          <div className="relative group overflow-hidden rounded-2xl border border-amber-100 bg-amber-50/20 dark:border-amber-950/40 dark:bg-slate-900/20 p-8 hover:shadow-lg transition-all duration-300">
            ...
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-amber-100 text-amber-600 dark:bg-amber-950 dark:text-amber-400 mb-6">
        ...
        <section>
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Pillars of Action</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">The focus areas that guide our daily initiatives and long-term planning.</p>
          </div>
              ...
              return (
                <div key={idx} className={`rounded-xl border p-7 ${pillar.color} hover:shadow-md transition-shadow`}>
                  <div className="flex items-center gap-4 mb-4">
                    <div className="rounded-lg p-2.5 bg-white dark:bg-slate-950 shadow-sm">
