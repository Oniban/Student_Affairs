        ...
        <div className="border-b border-slate-200 pb-8 dark:border-slate-800 mb-10 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-4xl">
              {activeTab === "directory" ? "Faculty & Staff Directory" : "Photo Gallery Showcase"}
            </h1>
            <p className="mt-3 text-base text-slate-600 dark:text-slate-400 max-w-2xl leading-relaxed">
              {activeTab === "directory"
                ? "Our dedicated team of administrators, counselors, and faculty are here to support your academic, residential, and personal needs."
                : "A curated collection of moments from campus events, sports achievements, student welfare programs, and daily life on campus."}
            </p>
          </div>
